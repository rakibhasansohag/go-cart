		...
		>
			...
			<div className='relative'>
				...
				<div
					...
					className={cn(
						'w-12 xl:w-[256px] h-12 rounded-full -translate-y-1 xl:translate-y-0 xl:h-11 bg-neutral-600 text-white text-xl relative flex items-center cursor-pointer transition-all duration-100 ease-in-out',
						{
