...
const SearchInput: FC<Props> = ({
	...
	return (
		<form
			...
			className='flex items-center border border-border bg-secondary hover:border-gray-400 focus-within:border-orange-background focus-within:ring-1 focus-within:ring-orange-background rounded-xl overflow-hidden transition-all duration-200 shadow-sm h-10 w-full max-w-[500px]'
		>
			{categoryLabel && (
