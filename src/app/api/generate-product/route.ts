...
1. Analyze the product description carefully based on the ${categoryName} > ${subCategoryLabel} context
...
12. **The 'name' field MUST be 2-200 characters long and ONLY contain letters, numbers, spaces, hyphens (-), underscores (_), ampersands (&), or apostrophes ('). Do NOT use consecutive special characters (e.g., no '--' or ' & ').**
