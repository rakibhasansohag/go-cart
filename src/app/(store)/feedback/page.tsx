			...
			<div className='max-w-5xl mx-auto space-y-10'>
				...
				<div className='grid grid-cols-1 lg:grid-cols-12 gap-8 items-start'>
					...
					<div className='lg:col-span-4 space-y-6'>
						...
						<div className='p-6 rounded-3xl border border-border/80 bg-card space-y-3'>
						...
						<div className='p-5 rounded-2xl border border-border bg-muted/20 space-y-2.5 text-xs text-muted-foreground'>
